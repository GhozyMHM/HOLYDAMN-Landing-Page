...
<body>
    ...
    <div class="wrap">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="Style/img/bannerHLDM1.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="Style/img/bannerHD2.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="Style/img/bannerHD3.jpg" class="d-block w-100" alt="...">
                    </div>
                </div>
            ...
            <div class="content portfolio" id="gallery">
                <div class="container">
                    ...
                    <div class="row templatemo_portfolio">
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="gallery-item">
                                <img src="Style/img/Pict1.jpeg" alt="gallery 7">
                                <div class="overlay">
                                    <a href="Style/img/Pict1.jpeg" data-rel="lightbox" class="fa fa-arrows-alt"></a>
                                </div>
                            </div>
        ...
        <div class="footer">
            ...
            <p id="copyright">HolyDamn &copy; 2020. All rights reserved.</p>
        </div>
        <!--Footer-->
